...
<section class="cta">
    <div class="container">
        <h2 class="cta__title">Ready to Experience Professional Service Excellence?</h2>
        <p class="cta__text">Contact Hedden Chong LLP today to discuss how our comprehensive services can benefit you or your business.</p>
        <div class="cta__actions">
            <a href="contact.php" class="btn btn--white btn--large">Contact Us Today</a>
            <a href="our-team.php" class="btn btn--secondary" style="color: white; border-color: white;">Meet Our Team</a>
        </div>
    </div>
</section>
