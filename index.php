...
<section class="hero hero--home" style="background-image: url('images/hero-home.jpg');">
    <div class="hero__content">
        ...
        <p class="hero__subtitle">Trust Hedden Chong LLP for comprehensive financial guidance, expert tax services, and strategic business solutions tailored to your needs.</p>
        <div class="hero__actions">
            <a href="contact.php" class="btn btn--white btn--large">Get Started Today</a>
            <a href="services.php" class="btn btn--secondary btn--large" style="color: white; border-color: white;">Our Services</a>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="grid grid--3">
            ...
            <div class="fade-in">
                ...
                <p>We understand that every client is unique. Our personalized approach ensures solutions tailored to your specific financial goals and business objectives.</p>
            </div>
            <div class="fade-in">
                <h3>Comprehensive Solutions</h3>
                <p>From tax preparation to complex business advisory services, we provide a full spectrum of accounting solutions under one roof.</p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="grid grid--3">
            <div class="testimonial fade-in">
                <p class="testimonial__quote">"Hedden Chong LLP has been instrumental in helping our business navigate complex tax regulations and maintain accurate financial records. Their expertise and attention to detail give us complete confidence in our financial operations."</p>
                <div class="testimonial__author">Sarah Mitchell</div>
                <div class="testimonial__company">CEO, Mitchell Manufacturing Ltd.</div>
            </div>
            
            <div class="testimonial fade-in">
                <p class="testimonial__quote">"The team at Hedden Chong provides exceptional service year-round, not just during tax season. Their proactive approach to tax planning has saved our family significant money over the years."</p>
                <div class="testimonial__author">Robert Chen</div>
                <div class="testimonial__company">Private Client</div>
            </div>
            
            <div class="testimonial fade-in">
                <p class="testimonial__quote">"As a non-profit organization, we need accountants who understand our unique needs. Hedden Chong LLP delivers professional service with a personal touch that makes all the difference."</p>
            ...
            <div class="testimonial fade-in">
                <p class="testimonial__quote">"Their business advisory services have been invaluable as we've grown from a startup to a thriving enterprise. The strategic insights and financial guidance have helped us make informed decisions at every stage."</p>
                <div class="testimonial__author">David Thompson</div>
                <div class="testimonial__company">Founder, Thompson Tech Solutions</div>
            </div>
            
            <div class="testimonial fade-in">
                <p class="testimonial__quote">"Professional, reliable, and always available when we need them. Hedden Chong LLP has been our trusted accounting partner for over fifteen years, and we wouldn't consider working with anyone else."</p>
...
<section class="cta">
    <div class="container">
        ...
        <p class="cta__text">Contact Hedden Chong LLP today to discuss how our comprehensive accounting and tax services can benefit you or your business.</p>
        <div class="cta__actions">
            <a href="contact.php" class="btn btn--white btn--large">Contact Us Today</a>
            <a href="tel:+16045550123" class="btn btn--secondary" style="color: white; border-color: white;">(604) 555-0123</a>
        </div>
    </div>
</section>
