...
setPageMeta('Kalen Chang - Junior Accountant', 'Kalen Chang is a Junior Accountant at Hedden Chong LLP, bringing fresh perspective and enthusiasm to accounting services and client support.');
?>
...
<nav class="breadcrumb">
    <div class="container">
        <ol class="breadcrumb__list">
            ...
            <li class="breadcrumb__item"><span class="breadcrumb__current">Kalen Chang</span></li>
        </ol>
    </div>
</nav>
        ...
        <div class="grid grid--2">
            ...
            <div class="fade-in">
                ...
                <ul>
                    ...
                    <li>Financial statement preparation support</li>
                    <li>Bookkeeping assistance</li>
