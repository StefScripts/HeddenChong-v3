...
setPageMeta('Tim Wong - Financial Advisor', 'Tim Wong is a Financial Advisor at Hedden Chong LLP with expertise in financial planning, investment advisory, and wealth management services.');
?>
...
<nav class="breadcrumb">
    <div class="container">
        <ol class="breadcrumb__list">
            ...
            <li class="breadcrumb__item"><span class="breadcrumb__current">Tim Wong</span></li>
        </ol>
    </div>
</nav>
