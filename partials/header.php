...
<head>
    ...
    <title><?php echo isset($page_title) ? $page_title . ' | Hedden Chong LLP' : 'Hedden Chong LLP - Professional Accounting Services'; ?></title>
    <meta name="description" content="<?php echo isset($page_description) ? $page_description : 'Professional accounting and tax services from Hedden Chong LLP. Serving clients since 1961 with expert financial guidance.'; ?>">
    
    <!-- Open Graph -->
    <meta property="og:title" content="<?php echo isset($page_title) ? $page_title . ' | Hedden Chong LLP' : 'Hedden Chong LLP - Professional Accounting Services'; ?>">
    <meta property="og:description" content="<?php echo isset($page_description) ? $page_description : 'Professional accounting and tax services from Hedden Chong LLP. Serving clients since 1961 with expert financial guidance.'; ?>">
